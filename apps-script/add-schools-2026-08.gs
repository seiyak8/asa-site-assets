...
const SCHOOLS_TO_ADD_2026_08 = [
  // インターナショナルスクール
  ['Wellington College International School Bangkok', 'en', '要調査 wellingtoncollege.ac.th'],
  ['King\'s College International School Bangkok', 'en', '要調査'],
  ['VERSO International School', 'en', '要調査 verso.ac.th'],
  ['Ascot International School', 'en', '要調査 ascot.ac.th'],
  ['Charter International School', 'en', '要調査'],
  ...
  // タイ私立・附属校
  ['Assumption College Thonburi', 'th', '要調査 U-13 Chang Junior Cup 2018優勝。サッカー強豪。優先度高'],
...
function addBangkokSchools2026() {
  ...
  SCHOOLS_TO_ADD_2026_08.forEach(function (school) {
    ...
    rows.push([school[0], '', school[1], '', '', '', school[2]]);
  });
